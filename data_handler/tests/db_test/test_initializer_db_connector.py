...
from data_handler.db.models import (
    ZkLendCollateralDebt, HashtackCollateralDebt
    )
...
def test_get_zklend_by_user_ids(mock_initializer_db_connector, sample_zklend_collateral_debt):
    ...
    :return: None
    """
    mock_initializer_db_connector.get_zklend_by_user_ids.return_value = [sample_zklend_collateral_debt]
...
def test_get_hashtack_by_loan_ids(mock_initializer_db_connector, sample_hashtack_collateral_debt):
    ...
    :return: None
    """
    mock_initializer_db_connector.get_hashtack_by_loan_ids.return_value = [sample_hashtack_collateral_debt]
...
def test_save_collateral_enabled_by_user_update(mock_initializer_db_connector, sample_zklend_collateral_debt):
    """
