...
from data_handler.db.models import (
    LoanState, InterestRate, OrderBookModel, 
    HashtackCollateralDebt, InterestRate
)
...
def test_get_last_interest_rate_record_by_protocol_id(mock_db_connector):
    ...
    mock_db_connector.get_last_interest_rate_record_by_protocol_id.return_value = mock_interest_rate
