...
def downgrade() -> None:
    ...
    op.create_index('ix_notification_email', 'notification', ['email'], unique=False)
    op.create_table('telegram_log',
    sa.Column('sent_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('notification_data_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('is_succesfully', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('message', sa.VARCHAR(), server_default=sa.text("''::character varying"), autoincrement=False, nullable=False),
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['notification_data_id'], ['notification.id'], name='telegram_log_notification_data_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='telegram_log_pkey')
    )
    # ### end Alembic commands ###
