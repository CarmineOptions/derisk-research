...
class Pool(Pair):
    ...
    def __init__(
        ...
        t1 = SwapAmmToken(
            ...
            decimal_factor=src.settings.TOKEN_SETTINGS[underlying_symbol_a].decimal_factor,
        ...
        t2 = SwapAmmToken(
            ...
            decimal_factor=src.settings.TOKEN_SETTINGS[underlying_symbol_b].decimal_factor,
...
class SwapAmm(Pair):
    ...
    def add_pool(self, t1: str, t2: str, pool_addresses: dict[str, str], myswap_id: int | None = None):
        pool = Pool(
            t1,
            t2,
            pool_addresses,
