...
class NostraAlphaLoanEntity(src.types.LoanEntity):
    ...
    def compute_debt_to_be_liquidated(
        ...
        for collateral_token_address in collateral_token_addresses:
            ...
            total_fee = liquidator_fee + collateral_token_parameters[collateral_token_address].protocol_fee
            ...
            max_liquidation_amount_usd = (
                debt_token_price * max_liquidation_amount / (10 ** debt_token_parameters[debt_token_addresses[0]].decimals)
            )
...
class NostraAlphaState(src.state.State):
    ...
    def __init__(
        ...
        self.debt_token_addresses_to_interest_bearing_collateral_token_addresses: dict[str, str] = {}
