    ...
    supply_figure = plotly.graph_objs.Figure(
        data = [
            plotly.graph_objs.Bar(
                ...
                marker = plotly.graph_objs.bar.Marker(color = '#66FF66'),
            ),
            plotly.graph_objs.Bar(
                name = 'Nostra Alpha',
                x = bar_chart_supply_stats.index,
                y = bar_chart_supply_stats['Nostra Alpha'],
                marker = plotly.graph_objs.bar.Marker(color = '#33CC33'),
            ),
            plotly.graph_objs.Bar(
                name = 'Nostra Mainnet', 
                x = bar_chart_supply_stats.index, 
                y = bar_chart_supply_stats['Nostra Mainnet'],
                marker = plotly.graph_objs.bar.Marker(color = '#006600'),
            ),
        ],
    )
    ...
    collateral_figure = plotly.graph_objs.Figure(
        data = [
            plotly.graph_objs.Bar(
                ...
                marker = plotly.graph_objs.bar.Marker(color = '#FFFF99'),
            ),
            plotly.graph_objs.Bar(
                name = 'Nostra Alpha', 
                x = bar_chart_collateral_stats.index, 
                y = bar_chart_collateral_stats['Nostra Alpha'],
                marker = plotly.graph_objs.bar.Marker(color = '#FFCC00'),
            ),
            plotly.graph_objs.Bar(
                name = 'Nostra Mainnet', 
                x = bar_chart_collateral_stats.index, 
                y = bar_chart_collateral_stats['Nostra Mainnet'],
                marker = plotly.graph_objs.bar.Marker(color = '#FF9900'),
            ),
        ],
    )
    ...
    debt_figure = plotly.graph_objs.Figure(
        data = [
            plotly.graph_objs.Bar(
                ...
                marker = plotly.graph_objs.bar.Marker(color = '#FF6666'),
            ),
            plotly.graph_objs.Bar(
                name = 'Nostra Alpha', 
                x = bar_chart_debt_stats.index, 
            ...
            plotly.graph_objs.Bar(
                ...
                marker = plotly.graph_objs.bar.Marker(color = '#990000'),
            ),
        ],
    )
