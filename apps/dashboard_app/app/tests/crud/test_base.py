...
def db_connector(mock_db_url: str) -> DBConnectorAsync:
    ...
    with patch("app.crud.base.create_async_engine") as mock_engine, \
...
class TestDBConnectorAsync:
    ...
    @pytest.mark.asyncio
    async def test_session_context_manager_success(self, db_connector: DBConnectorAsync, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_session_context_manager_with_sqlalchemy_error(self, db_connector: DBConnectorAsync, mock_session):
        """Test session context manager with SQLAlchemy error"""
        db_connector.session_maker.return_value = mock_session
        
        with pytest.raises(Exception, match="Error occurred while processing database operation"):
            async with db_connector.session() as session:
    ...
    @pytest.mark.asyncio
    async def test_write_to_db_success(self, db_connector: DBConnectorAsync, mock_session, sample_model_instance: MockModel):
    ...
    @pytest.mark.asyncio
    async def test_get_object_success(self, db_connector: DBConnectorAsync, mock_session, sample_model_instance: MockModel):
    ...
    @pytest.mark.asyncio
    async def test_get_object_not_found(self, db_connector: DBConnectorAsync, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_get_objects_success(self, db_connector: DBConnectorAsync, mock_session, sample_model_instance: MockModel):
    ...
    @pytest.mark.asyncio
    async def test_get_objects_empty_result(self, db_connector: DBConnectorAsync, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_delete_object_by_id_success(self, db_connector: DBConnectorAsync, mock_session, sample_model_instance: MockModel):
    ...
    @pytest.mark.asyncio
    async def test_delete_object_by_id_not_found(self, db_connector: DBConnectorAsync, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_delete_object_success(self, db_connector: DBConnectorAsync, mock_session, sample_model_instance: MockModel):
    ...
    @pytest.mark.asyncio
    async def test_write_to_db_with_sqlalchemy_error(self, db_connector: DBConnectorAsync, mock_session, sample_model_instance: MockModel):
    ...
    @pytest.mark.asyncio
    async def test_get_object_with_sqlalchemy_error(self, db_connector: DBConnectorAsync, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_delete_object_with_sqlalchemy_error(self, db_connector: DBConnectorAsync, mock_session, sample_model_instance: MockModel):
