...
def upgrade() -> None:
    ...
    if "protocol_id" not in [column['name'] for column in inspector.get_columns("accumulators_sync_event")]:
        op.create_table(
    ...
    if "protocol_id" not in [column['name'] for column in inspector.get_columns("borrowing_event")]:
        op.create_table(
            "borrowing_event",
    ...
    if "protocol_id" not in [column['name'] for column in inspector.get_columns("collateral_enabled_disabled_event")]:
        op.create_table(
    ...
    if "protocol_id" not in [column['name'] for column in inspector.get_columns("deposit_event")]:
        op.create_table(
            "deposit_event",
            sa.Column("user", sa.String(), nullable=False),
            sa.Column("token", sa.String(), nullable=False),
    ...
    if "protocol_id" not in [column['name'] for column in inspector.get_columns("liquidation_event")]:
        op.create_table(
            "liquidation_event",
    ...
    if "protocol_id" not in [column['name'] for column in inspector.get_columns("repayment_event")]:
        op.create_table(
            "repayment_event",
    ...
    if "protocol_id" not in [column['name'] for column in inspector.get_columns("withdrawal_event")]:
        op.create_table(
            "withdrawal_event",
            sa.Column("user", sa.String(), nullable=False),
