"""Nostra Mainnet protocol configuration and settings.

Contains mappings for contract events, method names and addresses for the Nostra Mainnet
protocol's smart contracts and liquidity pools.
"""
...
# Keys are tuples of event types and names, values are names of the respective 
# methods that process the given event.
...
NOSTRA_MAINNET_EVENTS_TO_ORDER: dict[str, str] = {
    ...
    ("nostra::core::tokenization::lib::nostra_token::"
     "NostraTokenComponent::Burn"): 7,
    "Mint": 8,
    ("nostra::core::tokenization::lib::nostra_token::"
     "NostraTokenComponent::Mint"): 9,
}
